...
const Billing = () => (
  <section id="product" className={layout.sectionReverse}>
    ...
    <div className={layout.sectionInfo}>
      ...
      <p className={`${styles.paragraph} max-w-[470px] mt-5`}>No 
      more tracing and scouring through statements. Our 
      platform makes for a seamless experience to see all your 
